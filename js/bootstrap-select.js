    ...
    createLi: function() {
      ...
      this.$element.find('option').each(function(index) {
        ...
        if ($this.data('thumbnail')) {
          ...
          text =
            '<span class="media">' +
              '<span class="mr-2"><img src="' + $this.data('thumbnail') + '" class="media-object" onerror="src=\'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7\'"></span>' +
